...
> 本页只治理关系专项文件身份、读取顺序与覆盖关系，不发明理论。先读核心表，再通过本索引进入专项正本；三元与十元并行。
...
| 关系 | 专项正本 | 状态 | 直接上位 |
|---|---|---|---|
| xn 生 xz | `xn生xz_结构把偏离转成临界风险正式机制_20260719.md` | canonical-current | 核心表几何位 |
| zx 克 n | `zx克n_公开权能击穿承载机制审计_20260718.md` | canonical-current | 核心表几何位 |
| x并z 生 z | `x并z生z_可识别壳建立认可接口正式机制_20260719.md` | canonical-current | 核心表几何位 |
| x 生 x并z | `x生x并z_掌握边界生成公开壳正式机制_20260719.md` | canonical-current | 核心表几何位 |
| x 克 z | `x克z_掌握认可接口压制确认正式机制_20260719.md` | canonical-current | 核心表几何位 |
| n 克 xz | `n克xz_承载结构吸收临界风险正式机制_20260719.md` | canonical-current | 核心表几何位 |
| zn 补 x | `zn补x_意义核心与掌握边界互补正式机制_20260719.md` | canonical-current | 核心表补位 |
| n 补 x并z | `n补x并z_承载内部与公开界面互补正式机制_20260719.md` | canonical-current | 核心表补位 |
...
| zn 克 xn | `zn克xn_意义撤回结构自愿再生产正式机制_20260720.md` | canonical-current | 核心表几何位 |
| xn 克 zx | `xn克zx_既有结构限制即时显权扩张正式机制_20260721.md` | canonical-current | 核心表几何位 |
| zx 补 nx | `zx补nx_直接显权与关系借力互补正式机制_20260721.md` | canonical-current | 核心表补位 |
...
- `xz补nz_总词典旧题材口径撤回与正式机制同步补丁_20260720.md`
  - 目标机制已经进入核心表、关系词典与强制必读中枢；但文件自身仍标记 `canonical-sync-patch`，且含独有长篇审计材料。本轮不以短桩替换删除材料，下一批需采用保留全文的 frontmatter 安全改写后再移入“已并入”。
